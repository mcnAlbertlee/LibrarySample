...
/**
 * PublishSubject 는 이미 발행한 아이템은 무시하고 구독시점 이후부터 발행한 아이템만 받음
 */
public class PublishSubjectExampleActivity extends RxBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setScreenTitle(getResources().getString(R.string.bt_rx_publish_subject));
    }
